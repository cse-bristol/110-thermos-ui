(ns thermos-ui.frontend.candidate-editor
  (:require [thermos-ui.specs.candidate :as candidate]
            [thermos-ui.specs.demand :as demand]
            [thermos-ui.specs.path :as path]
            [thermos-ui.specs.document :as document]
            [thermos-ui.frontend.popover :as popover]
            [thermos-ui.frontend.editor-state :as state]
            [thermos-ui.frontend.inputs :as inputs]
            [thermos-ui.frontend.format :as format]
