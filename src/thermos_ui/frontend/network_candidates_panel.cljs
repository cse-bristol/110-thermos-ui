...
(defn component
  ...
  [document]
  (let [all-filters @(reagent/track #(operations/get-all-table-filters @document))
        ...
        open-filter @(reagent/cursor document [::view/view-state ::view/table-state ::view/open-filter])
      ...
      [:div {:class (str
       ...
       [virtual-table/component
        ...
        {:label "Selected"
         ...
         :headerRenderer (fn [args] (filterable-header-renderer document
                                                                open-filter
                                                                filtered-candidates
                                                                items
                                                                ::candidate/selected
...
(defn filterable-header-renderer
  ...
  [doc open-filter filtered-candidates items key args type is-open]
  (reagent/as-element
