...
(def ^:const CIVIL-COST-FIELD "CIVIL-COST")
...
(def ^:const SUPPLY-CAPACITY-FIELD    "SUPPLY-CAPACITY-KW")
(def ^:const SUPPLY-FIXED-CAPEX-FIELD "SUPPLY-FIXED-CAPEX")
(def ^:const SUPPLY-KWP-CAPEX-FIELD   "SUPPLY-CAPEX-PER-KWP")
(def ^:const SUPPLY-KWP-COST-FIELD    "SUPPLY-OPEX-PER-KWP")
(def ^:const SUPPLY-KWH-COST-FIELD    "SUPPLY-HEAT-C-PER-KWH")
