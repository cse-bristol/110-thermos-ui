ALTER TABLE candidates ADD COLUMN user_fields jsonb;
--;;
UPDATE candidates SET user_fields = jsonb_build_object('Name', name, 'Category', type);
--;;
...
;
--;;
ALTER TABLE candidates DROP COLUMN name, DROP COLUMN type;
